...
const productListings: Record<string, readonly IndiaMartCategory[]> = {
  ...
  "cr-semi-hard-cutting": [c.coldRolledCoils, c.galvanizedPlainCoils],
  "bp-sheet": [c.coldRolledCoils, c.crSheets, c.stainlessSteelBhatti],
  "ac-stand": [c.newItems],
  ...
  "shutter-channel": [c.rollingShutter, c.hrSheet],
