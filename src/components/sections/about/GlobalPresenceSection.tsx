...
const HUBS: HubLocation[] = [
  {
    ...
    description: "Central processing hub with CTL machines, cranes, annealing furnaces, administrative head office, and massive steel storage yard serving Madhya Pradesh.",
  ...
  },
  {
    id: "mumbai",
    name: "Mumbai Hub",
    description: "Key port connection, import sourcing terminal, and Western supply-chain logistics base serving Maharashtra.",
  ...
  },
  {
    id: "gujarat",
    name: "Gujarat Hub",
    description: "Regional distribution center facilitating prompt transport access across Gujarat industries including Rajkot and surrounding areas.",
    type: "Distribution & Processing Hub",
    x: 27.0,
    y: 52.5,
  },
  {
    id: "bokaro",
    name: "Bokaro Hub",
    description: "Strategic sourcing hub placed near premier raw steel manufacturing centers, supporting operations across Punjab and Northern India.",
